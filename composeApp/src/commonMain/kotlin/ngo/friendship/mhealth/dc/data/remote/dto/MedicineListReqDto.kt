...
data class MedicineListReqDto(
    ...
    @SerialName("dataLength") val dataLength: Int,
    @SerialName("data") val data: Map<String, String> = emptyMap(),
    @SerialName("lang") val lang: String,
    @SerialName("param1") val param1: Map<String, String>
) {
    companion object {
        fun build(
            userName: String,
