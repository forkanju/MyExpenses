...
@Serializable
data class BeneficiaryProfileReqDto(
    ...
    @SerialName("requestName") val requestName: String = "BENEFICIARY_PROFILE",
    ...
    companion object {
        fun build(
            ...
            requestTime: String,
            benefCode: String
        ) = BeneficiaryProfileReqDto(
            userCode = userName.md5(),
            password = password.md5(),
            requestTime = requestTime,
            param1 = mapOf("BENEF_CODE" to benefCode)
        )
    }
}
