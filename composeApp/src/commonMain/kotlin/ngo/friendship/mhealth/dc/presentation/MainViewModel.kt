...
//) : BaseViewModel() {
//
//    private val _uiEvent = MutableSharedFlow<MainUiEvent>(replay = 1)
//    val uiEvent = _uiEvent.asSharedFlow()
//
//    init {
//        viewModelScope.launch {
//            notifierManager.notificationClickFlow.collect { data ->
//                println("MainViewModel: Notification Click event received! Going to Cases.")
//                println("MainViewModel: Notification Click data: $data")
//                _uiEvent.emit(MainUiEvent.OpenCasesTab)
//            }
//        }
//    }
//
//    fun openCasesTabFromNotification() {
//        launch {
//            println("MainViewModel: emitting OpenCasesTab")
//            _uiEvent.emit(MainUiEvent.OpenCasesTab)
//        }
//    }
//
...
//        launch {
//            _uiEvent.emit(MainUiEvent.Idle)
//        }
//    }
//
